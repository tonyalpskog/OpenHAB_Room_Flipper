...
public class LessThanNumberRuleOperationTest {
    private LessThanNumberRuleOperation mSut;

    @Before
    public void setUp() throws Exception {

        mSut = new LessThanNumberRuleOperation();
    }
    ...
    @Test
    public void getValue_givenLeftNumberLargerThanRight_returnFalse() {
    ...
    @Test
    public void getValue_givenLeftNumberLessThanRight_returnTrue() {
    ...
    @Test
    public void getValue_givenLeftNumberEqualToRight_returnFalse() {
        mSut.setLeft(new UnitEntityDataType<Number>(3, Number.class));
        mSut.setRight(new UnitEntityDataType<Number>(3, Number.class));
        assertThat(mSut.getValue(), is(equalTo(false)));
    }
