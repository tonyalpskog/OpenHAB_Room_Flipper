...
import org.openhab.habclient.dagger.DaggerRoomConfigActivityComponent;
...
public class RoomConfigActivity extends Activity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DaggerRoomConfigActivityComponent.builder()
...
//        .setOnTabChangedListener(this);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        private RoomConfigFragment mRoomConfigFragment;
        private UnitPlacementFragment mUnitPlacementFragment;
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    if(mRoomConfigFragment == null)
                        mRoomConfigFragment = RoomConfigFragment.newInstance();
                    return mRoomConfigFragment;
                case 1:
                    if(mUnitPlacementFragment == null)
                        mUnitPlacementFragment = UnitPlacementFragment.newInstance(0);
                    return mUnitPlacementFragment;
            }
